...
Core.Agent.Admin.ProcessManagement.Canvas = (function (TargetNS) {
    ...
    TargetNS.CreateActivity = function (EntityID, EntityName, ActivityID, PosX, PosY) {
        ...
        $('#Canvas')
            .append('<div class="Activity Task" id="' + EscapeHTML(EntityID) + '"><span>' + EscapeHTML(EntityName) + '</span><div class="TaskTypeIcon" style="display: block; position: absolute; top: 10px; left: 10px;"><i class="fa fa-user fa-lg"></i></div><div class="Icon Loader"></div><div class="Icon Success"></div></div>')
            .find('#' + EntityID)
            .css({
                'top' : PosY + 'px',
                'left': PosX + 'px'
