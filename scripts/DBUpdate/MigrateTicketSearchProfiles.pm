...
package scripts::DBUpdate::MigrateTicketSearchProfiles;    ## no critic
...
scripts::DBUpdate::MigrateTicketSearchProfiles - Migrate ticket search profiles article field keys and values.
