            ...
            )
        {
...

            {
                ...
                if ( $RequestMethod eq 'post' ) {
                    ...
                    $ENV{REQUEST_URI}    = "http://localhost/ligero/nph-genericinterface.pl/$WebserviceAccess";
                    ...
                    # prepare CGI environment variables
                    $ENV{REQUEST_URI}
                        = "http://localhost/ligero/nph-genericinterface.pl/$WebserviceAccess?" . $QueryString;
