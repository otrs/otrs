...
$Selenium->RunTest(
    sub {
        ...
        # see bug#12850 ( https://bugs.ligero.org/show_bug.cgi?id=12850 ).
        ...
        # Check pre-selected process is loaded correctly, see bug#12850 ( https://bugs.ligero.org/show_bug.cgi?id=12850 ).
        $Self->True(
        ...
        # See bug#11512 (https://bugs.ligero.org/show_bug.cgi?id=11512).
        $Self->True(
