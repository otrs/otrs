...
sub Data {
    ...
    $Self->{Completeness}        = 0.0815590659340659;
    ...
    $Self->{Translation} = {
        ...
        'After doing so your LIGERO is up and running.' => '',
        'Start page' => '',
        'Your LIGERO Team' => '',
        ...
        # Template: Test
        'LIGERO Test Page' => 'صفحة التجربة ل LIGERO',
        'Unlock' => 'فك',
        'Welcome %s %s' => '',
        'Counter' => 'العداد',
...
' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'بريدك مع رقم البطاقة  "<LIGERO_TICKET>" دمجت مع "<LIGERO_MERGE_TO_TICKET>".',
