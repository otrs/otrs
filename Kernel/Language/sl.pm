...
sub Data {
    ...
    $Self->{Completeness}        = 0.227335164835165;
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this LIGERO system.' =>
            'Novi uporabnik baze z omejenimi pravicami bo ustvarjen za ta LIGERO sistem',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Da biste mogli koristiti LIGERO morate unijeti slijedeću liniju u Vašu komandnu liniju (Terminal/Shell) kao "root".',
        'Restart your webserver' => 'Ponovno zaženite Vaš WEB Server.',
        'After doing so your LIGERO is up and running.' => 'Po tem bo vaš LIGERO pripravljen na delo.',
        ...
        'Fully qualified domain name of your system.' => 'FQDN - ime servera uključujući puno ime domena, npr. "ligero-server.example.org"',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO testna stran',
        'Unlock' => 'Sprosti',
        'Welcome %s %s' => '',
        'Counter' => 'Števec',
        ...
        'The partition where LIGERO is located is almost full.' => 'Razdelek kjer je nameščen LIGERO je skoraj poln.',
...
' => '',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Novice o različicah LIGERO!',
        'News about LIGERO.' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Vaše sporočilo E-pošte s številko zahtevka "<LIGERO_TICKET>" je združena z zahtevkom "<LIGERO_MERGE_TO_TICKET>"!',
