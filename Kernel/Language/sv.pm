...
sub Data {
    ...
    $Self->{Completeness}        = 0.378090659340659;
    ...
    $Self->{Translation} = {
        ...
        'To create a new ACL you can either import ACLs which were exported from another system or create a complete new one.' =>
            'För att skapa en ACL-regel kan du antingen importera ACL-regler som exporterats från en annan LIGERO-installation eller skapa en ny.',
        ...
        'Support data collector' => 'Supportdata-insamlaren',
        'Hint' => 'Tips',
        'Currently support data is only shown in this system.' => 'Supportdata finns för tillfället endast lokalt i din LIGERO-installation.',
        'It is highly recommended to send this data to LIGERO Group in order to get better support.' =>
            'Det rekommenderas att du skickar denna data till LIGERO-Gruppen för att få bättre support.',
        ...
        'This will allow the system to send additional support data information to LIGERO Group.' =>
            'Aktiverar rätt för systemet att skicka ytterligare supportdatainformation till LIGERO Group.',
        'Update' => 'Uppdatera',
        'System Registration' => 'Registrera LIGERO-installationen',
        'To enable data sending, please register your system with LIGERO Group or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'För att skicka supportdata behöver du registrera din LIGERO-installation eller uppdatera en tidigare registrering hos LIGERO group samt slå på \'skicka supportdata\'-inställningen.',
        'Register this System' => 'Registrera denna LIGERO-installation',
        'System Registration is disabled for your system. Please check your configuration.' =>
            'Registering är inaktiverad för LIGERO-installationen. Kontrollera konfigurationen.',

        # Template: AdminCloudServices
        'System registration is a service of LIGERO Group, which provides a lot of advantages!' =>
            'Systemregistreringen hos LIGERO Group kan vara fördelaktig men är ej obligatorisk.',
        'Please note that the use of LIGERO cloud services requires the system to be registered.' =>
            'För att använda LIGERO-cloudtjänsterna behöver LIGERO-installationen registreras.',
        'Register this system' => 'Registrera denna LIGERO-installation',
        ...
        'e.g https://www.ligero.com:10745/api/v1.0 (without trailing backslash)' =>
            't.ex. https://www.ligero.com:10745/api/v1.0 (utan avslutande snedstreck)',
        'Timeout' => '',
        ...
        'Go to LIGERO Package Manager' => 'Gå till LIGERO-pakethanteraren',
        ...
        'To be able to use PGP in LIGERO, you have to enable it first.' => 'För att använda PGP i LIGERO, måste du aktivera det först.',
        ...
        'LIGERO Verify™ can not continue!' => 'LIGERO Verify™ kan inte fortsätta!',
        ...
        'This package is verified by LIGEROverify (tm)' => 'Det här paketet är verifierat av LIGEROverify (tm)',
        ...
        'System Registration Management' => 'Registrering av LIGERO-installationen',
        'Edit System Registration' => '',
        'System Registration Overview' => '',
        'Register System' => '',
        'Validate LIGERO-ID' => '',
        'Deregister System' => 'Avregistrera LIGERO-installationen',
        'Edit details' => '',
        'Show transmitted data' => 'Visa överförda data',
        'Deregister system' => 'Avregistrera LIGERO-installationen',
        'Overview of registered systems' => 'Översikt över registrerade LIGERO-installationer',
        'This system is registered with LIGERO Group.' => 'Denna LIGERO-installation är registrerad hos LIGERO Group.',
        ...
        'Please note that you can\'t register your system if LIGERO Daemon is not running correctly!' =>
            'Systemregisteringen kräver att LIGERO-demonen körs.',
        'Instructions' => 'Instruktioner',
        'System Deregistration not Possible' => '',
        'Please note that you can\'t deregister your system if you\'re using the %s or having a valid service contract.' =>
            'Du kan inte avregistrera LIGERO-installationen om du använder %s eller har ett giltigt serviceavtal. ',
        'LIGERO-ID Login' => 'LIGERO-ID-inloggning',
        'Read more' => 'Läs mer',
        'You need to log in with your LIGERO-ID to register your system.' =>
            'Logga in med ditt LIGERO-ID för att registrera LIGERO-installationen.',
        'Your LIGERO-ID is the email address you used to sign up on the LIGERO.com webpage.' =>
            'Ditt LIGERO-ID är den e-postadress du använde för att registrera dig på LIGERO.com.',
        'Data Protection' => 'Dataskydd för personuppgifter',
        'What are the advantages of system registration?' => 'Vilka är fördelarna med att registrera LIGERO-installationen?',
        'You will receive updates about relevant security releases.' => '',
        'With your system registration we can improve our services for you, because we have all relevant information available.' =>
            'Genom att registrera LIGERO-installationen kan informationen du tillhandahåller hjälpa LIGERO Group att förbättra tjänsterna.',
        'This is only the beginning!' => '',
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use LIGERO without being registered?' => 'Kan jag använda LIGERO utan att vara registrerad?',
        'System registration is optional.' => 'Registrering av LIGERO-installationen är inte obligatorisk.',
        'You can download and use LIGERO without being registered.' => 'Du kan hämta och använda LIGERO utan registrering av installationen.',
        'Is it possible to deregister?' => 'Kan man avregistrera en LIGERO-installation?',
        'You can deregister at any time.' => 'Du kan avregistrera en LIGERO-installation när som helst.',
        'Which data is transfered when registering?' => 'Vilka uppgifter skickas vid registrering av LIGERO-installationen?',
        'A registered system sends the following data to LIGERO Group:' => 'Följande skickas om LIGERO-installationen till LIGERO Group:',
        'Fully Qualified Domain Name (FQDN), LIGERO version, Database, Operating System and Perl version.' =>
            'Domännamnet (FQDN), LIGERO-version, databastyp, samt OS- och Perl-version.',
        ...
        'The description and system type you specify help you to identify and manage the details of your registered systems.' =>
            'Systembeskrivningen och -typen gör det lättare att hålla reda på uppgifterna om dina registrerade LIGERO-installationer.',
        'How often does my LIGERO system send updates?' => 'Hur ofta skickar LIGERO-installationen uppdateringar?',
        'Your system will send updates to the registration server at regular intervals.' =>
            'Din LIGERO-installation skickar regelbundet uppdateringar till registreringsservern.',
        'Typically this would be around once every three days.' => 'Vanligtvis sker det var tredje dag.',
        'If you deregister your system, you will lose these benefits:' =>
            'Om du avregistrerar LIGERO-installationen avstår du från följande:',
        'You need to log in with your LIGERO-ID to deregister your system.' =>
            'Du behöver logga in med ditt LIGERO-ID för att avregistrera LIGERO-installationen.',
        'LIGERO-ID' => 'LIGERO-ID',
        'You don\'t have an LIGERO-ID yet?' => 'Saknar du LIGERO-ID?',
        ...
        'This data will be frequently transferred to LIGERO Group when you register this system.' =>
            'Supportdata skickas regelbundet till LIGERO Group om du registrerar den här LIGERO-installationen.',
        'Attribute' => 'Attribut',
        'FQDN' => 'FQDN',
        ...
        'Continuing with this step will deregister the system from LIGERO Group.' =>
            'Genom att slutföra detta steg avregistreras LIGERO-installationen hos LIGERO Group.',
        'Deregister' => 'Avregistrera',
        'You can modify registration settings here.' => '',
        'Overview of Transmitted Data' => '',
        'There is no data regularly sent from your system to %s.' => 'Inga data skickas regelbundet från LIGERO-installationen till %s.',
        'The following data is sent at minimum every 3 days from your system to %s.' =>
            'Följande supportdata om LIGERO-installationen skickas var tredje dag till %s.',
        ...
        'This data is sent to LIGERO Group on a regular basis. To stop sending this data please update your system registration.' =>
            'Supportdata skickas regelbundet till LIGERO Group. För att upphöra med det behöver du ändra registreringen av LIGERO-installationen.',
        'You can manually trigger the Support Data sending by pressing this button:' =>
            '',
        'Send Update' => 'Skicka uppdatering',
        'Currently this data is only shown in this system.' => 'Supportdata finns för tillfället endast lokalt i din LIGERO-installation.',
        ...
        'A running LIGERO Daemon is mandatory for correct system operation.' =>
            'LIGERO-demonen behöver köras för att systemet ska fungera som det ska.',
        'Starting the LIGERO Daemon' => 'Startar LIGERO-demonen',
        ...
        'After 5 minutes, check that the LIGERO Daemon is running in the system (\'bin/ligero.Daemon.pl status\').' =>
            'Kontroller om fem minuter att LIGERO-demonen körs (\'bin/ligero.Daemon.pl status\').',
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating LIGERO at %s.' => 'Visste du att du kan hjälpa till att översätta LIGERO på %s.',
        ...
        'Create a new database for LIGERO' => 'Skapa en ny databas för LIGERO-installationen',
        'Use an existing database for LIGERO' => 'Använd en existerande databas för LIGERO-installationen',
        ...
        'A new database user with limited permissions will be created for this LIGERO system.' =>
            'En ny databasanvändare med begränsade rättigheter kommer att skapas för LIGERO-installationen.',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'För att kunna använda LIGERO, måste följende rad skrivas på kommandoraden som root.',
        'Restart your webserver' => 'Starta om din webbserver',
        'After doing so your LIGERO is up and running.' => 'Efter detta är LIGERO igång.',
        'Start page' => 'Startsida',
        'Your LIGERO Team' => 'Ditt LIGERO-Team',
        ...
        'System FQDN' => ' LIGERO-installationens värdnamn (FQDN)',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO Test-sida',
        'Unlock' => 'Lås upp',
        ...
        'Update and extend your system with software packages.' => 'Utöka LIGERO-installationen med ytterligare programpaket.',
        ...
        'LIGERO as provider' => 'LIGERO-installationen svarar på request (tillhandahållare)',
        'Operations' => '',
        'LIGERO as requester' => 'LIGERO-installationen skickar request',
        'Invokers' => '',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'Paketet är inte kontrollerat av LIGERO-gruppen! Du bör inte använda det.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Install LIGERO' => 'Installera LIGERO',
        'Intro' => 'Intro',
        ...
        'Contact your Admin!' => '',
        'System Settings' => 'Inställningar för LIGERO-installationen',
        'Syslog' => '',
        ...
        'Enable cloud services to unleash all LIGERO features!' => 'Aktivera molntjänster för att släppa loss alla LIGERO funktioner!',
        ...
        'LIGERO Daemon is not running.' => 'LIGERO-demonen körs inte.',
        ...
        'LIGERO Disk Partition' => 'LIGERO diskpartition',
        ...
        'Daemon' => '',
        'Daemon is running.' => '',
        'Daemon is not running.' => 'LIGERO-demonen körs inte.',
        ...
        'The file system on your LIGERO partition is not writable.' => 'Filsystemet på din LIGERO-partition är inte skrivbart.',
        ...
        'Your SystemID setting is invalid, it should only contain digits.' =>
            'LIGERO-installationens system-ID är ogiltigt. Det ska enbart bestå av siffror.',
        ...
        'Information about the LIGERO Daemon' => 'Information om LIGERO-demonen',
...
' => '',
        ...
        'Default ticket ID used by the system in the customer interface.' =>
            'Ärende-ID att användas av LIGERO-installationen i kundgränssnittet.',
        ...
        'Main menu registration.' => 'Huvudmeny för registrering av LIGERO-installationen.',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Nyheter om LIGERO-releaser!',
        'News about LIGERO.' => '',
        ...
        'We are performing scheduled maintenance. We should be back online shortly.' =>
            'Schemalagt underhåll pågår. LIGERO-instansen är snart tillgänglig igen.',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is bounced to "<LIGERO_BOUNCE_TO>". Contact this address for further information.' =>
            'Ditt e-brev med ärendenummer "<LIGERO_TICKET>" studsades till "<LIGERO_BOUNCE_TO>". För mer information kontakta dem.',
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Ditt ärende "<LIGERO_TICKET>" har slagits samman med "<LIGERO_MERGE_TO_TICKET>".',
