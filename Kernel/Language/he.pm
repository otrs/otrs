...
sub Data {
    ...
    $Self->{Completeness}        = 0.241758241758242;
    ...
    $Self->{Translation} = {
        ...
        'This system is registered with LIGERO Group.' => 'מערכת זו רשומה עם קבוצת LIGERO.',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use LIGERO without being registered?' => 'האם אפשר להשתמש ב- LIGERO בלי להירשם',
        ...
        'A registered system sends the following data to LIGERO Group:' => 'רישום מערכת שולח את המידע הבא לקבוצת LIGERO:',
        ...
        'The description and system type you specify help you to identify and manage the details of your registered systems.' =>
            '',
        'How often does my LIGERO system send updates?' => 'כל כמה זמן נשלחים עדכונים למערכת LIGERO?',
        ...
        'After doing so your LIGERO is up and running.' => 'לאחר שמערכת LIGERO תותקן.',
        ...
        # Template: Test
        'LIGERO Test Page' => 'עמוד בדיקה LIGERO',
        'Unlock' => 'שחרר נעילה',
        'Welcome %s %s' => '',
        'Counter' => 'מונה',
        ...
        'LIGERO as provider' => 'LIGERO כמספק',
        'Operations' => '',
        'LIGERO as requester' => 'LIGERO כמבקש',
        'Invokers' => '',
...
' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'הדוא"ל שלכם עם פניה מספר "<LIGERO_TICKET>" מוזגה עם פניה "<LIGERO_MERGE_TO_TICKET>".',
