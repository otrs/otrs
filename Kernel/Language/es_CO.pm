...
sub Data {
    ...
    $Self->{Completeness}        = 0.345982142857143;
    ...
    $Self->{Translation} = {
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'Paquete no verificado por el grupo LIGERO! No es recomendable usarlo.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'LIGERO Daemon is not running.' => 'El vigilante de',
...
' => '',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Noticias de lo nuevo en LIGERO!',
        'News about LIGERO.' => '',
