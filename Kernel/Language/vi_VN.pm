...
sub Data {
    ...
    $Self->{Completeness}        = 0.159684065934066;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to LIGERO Group in order to get better support.' =>
            'Chúng tối khuyến nghị gửi dữ liệu này đến Nhóm LIGERO để hỗ trợ tốt hơn.',
        'Configuration' => 'Cấu h',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Để có thể sử dụng LIGERO bạn phải nhập dòng sau vào dòng lệnh của bạn (Terminal/Shell) làm gốc.',
        'Restart your webserver' => 'Khởi động lại máy chủ web.',
        'After doing so your LIGERO is up and running.' => 'Sau khi thực hiện LIGERO của bạn đã hoạt động.',
        'Start page' => 'Trang bắt đầu',
        'Your LIGERO Team' => 'Đội LIGERO của bạn',
        ...
        # Template: Test
        'LIGERO Test Page' => 'Trang test LIGERO',
        'Unlock' => 'Mở khóa',
        'Welcome %s %s' => '',
        'Counter' => 'Bộ đếm',
        ...
        'LIGERO as provider' => 'LIGERO là nhà cung cấp ',
        'Operations' => '',
        'LIGERO as requester' => 'LIGERO như yêu cầu',
        'Invokers' => '',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'Gói không được xác nhận bởi tập đoàn LIGERO! Đó là khuyến cáo không sử dụng gói này.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'LIGERO Disk Partition' => '',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => '',
        'The partition where LIGERO is located is almost full.' => '',
        ...
        'LIGERO' => 'Open Technology Real Services',
...
' => '',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Tin tức về phiên bản LIGERO',
        'News about LIGERO.' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'E-mail của bạn với số thẻ "<LIGERO_TICKET>" được trộn thành "<LIGERO_MERGE_TO_TICKET>"!',
