...
sub Data {
    ...
    $Self->{Completeness}        = 0.191449175824176;
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this LIGERO system.' =>
            'Šiai LIGERO sistemai bus sukurtas naujas, apribotas teises turintis, duomenų bazės naudotojas.',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Norėdami naudoti LIGERO turite root naudotojo teisėmis, komandinėje eilutėje (terminale), įvesti šią komandą.',
        'Restart your webserver' => 'Perkraukite savo web serverį.',
        'After doing so your LIGERO is up and running.' => 'Atlikus šiuos veiksmus bus paleista LIGERO sistema.',
        'Start page' => 'Pradinis puslapis',
        'Your LIGERO Team' => 'Jūsų LIGERO komanda',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO Bandomasis puslapis',
        'Unlock' => 'Atrakinti',
        'Welcome %s %s' => '',
        'Counter' => 'Skaitliukas',
...
' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Jūsų el. laiškas trikties numeriu "<LIGERO_TICKET>" yra sujungtas su "<LIGERO_MERGE_TO_TICKET>"!',
