...
sub Data {
    ...
    $Self->{Completeness}        = 0.214800824175824;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to LIGERO Group in order to get better support.' =>
            'Препоръчително е да изпратите тези данни на LIGERO група, за да получите по-добра поддръжка.',
        ...
        'This will allow the system to send additional support data information to LIGERO Group.' =>
            'Това ще позволи на системата да изпрати допълнителна информация за данните за поддръжка на LIGERO Групата.',
        'Update' => 'Обновяване',
        ...
        'To enable data sending, please register your system with LIGERO Group or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'За да активирате изпращането на данни, моля, регистрирайте системата си в LIGERO Group или актуализирайте системната си регистрационна информация (не забравяйте да активирате опцията "изпращане на данни за поддръжка").',
        ...
        'System registration is a service of LIGERO Group, which provides a lot of advantages!' =>
            'Системната регистрация е услуга на LIGERO Group, която предоставя много предимства!',
        'Please note that the use of LIGERO cloud services requires the system to be registered.' =>
            'Моля, имайте предвид, че използването на облачни услуги на LIGERO изисква системата да бъде регистрирана.',
        'Register this system' => 'Регистриране на тази Система',
        ...
        'This LIGERO invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Този модул за обратна връзка на LIGERO заявки ще бъде извикан, за да подготви данните, които да бъдат изпратени до отдалечената система, и да обработва данните за отговори.',
        ...
        'The data from the invoker of LIGERO will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Данните от заявката на LIGERO ще бъдат обработени от това картографиране, за да се превърнат в вид данни, които отдалечената система очаква.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of LIGERO expects.' =>
            'Данните за отговорите ще бъдат обработени от това картографиране, за да бъдат преработени в типа данни, които заявката на LIGERO очаква.',
        ...
        'Asynchronous event triggers are handled by the LIGERO Scheduler Daemon in background (recommended).' =>
            'Асинхронните събития се обработват от LIGERO Scheduler Daemon на заден план (препоръчително).',
        ...
        'This LIGERO operation backend module will be called internally to process the request, generating data for the response.' =>
            'Този модул за обратна връзка за операцията LIGERO ще бъде наречена вътрешно, за да обработи заявката, генерирайки данни за отговора.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data LIGERO expects.' =>
            'Данните за заявката ще бъдат обработени от това картографиране, за да се предоставят в вида данни, който LIGERO очаква.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that LIGERO will process.' =>
            'Тук можете да зададете максималния размер (в байтове) на съобщенията, които LIGERO ще обработва.',
        ...
        'e.g https://www.ligero.com:10745/api/v1.0 (without trailing backslash)' =>
            'Например https://www.ligero.com:10745/api/v1.0 (без последващо наклонена черта)',
        'Timeout' => '',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that LIGERO will process.' =>
            'Тук можете да посочите максималния размер (в байтове) на SOAP съобщения, които LIGERO ще обработва.',
        'Encoding' => 'Кодиране',
        ...
        'In provider mode, LIGERO offers web services which are used by remote systems.' =>
            'В модула за доставчици LIGERO предлага уеб услуги, които се използват от отдалечени системи.',
        'In requester mode, LIGERO uses web services of remote systems.' =>
            'В режим "рикуестър" LIGERO използва уеб услуги на отдалечени системи.',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'За да може да използвате LIGERO, Вие трябва да въведете, като superuser root в командния ред (Terminal/Shell) следната команда',
        'Restart your webserver' => 'Рестарт на web сървъра',
        'After doing so your LIGERO is up and running.' => 'След извършването на това, Вашият LIGERO е напълно работоспособен.',
        'Start page' => 'Начална страница',
        'Your LIGERO Team' => 'Вашият LIGERO екип',
        ...
        # Template: Test
        'LIGERO Test Page' => 'Тестова страница на LIGERO',
        'Unlock' => 'Отключи',
        'Welcome %s %s' => '',
        'Counter' => 'Брояч',
        ...
        'LIGERO as provider' => 'LIGERO като доставчик',
        'Operations' => '',
        'LIGERO as requester' => 'LIGERO като рикуестър',
        'Invokers' => '',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'Пакетът не е проверен от LIGERO група! Препоръчва се да не се използва тази пакет.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Install LIGERO' => 'Инсталирай LIGERO',
        'Intro' => 'Въведение',
        ...
        'Enable cloud services to unleash all LIGERO features!' => 'Активирайте облачните услуги, за да отключите всички функции на LIGERO.',
        ...
        'LIGERO Daemon is not running.' => 'LIGERO Daemon не се изпълнява.',
...
' => '',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Новини за LIGERO са публикувани.',
        'News about LIGERO.' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Вашето писмо с номер на билета "<LIGERO_TICKET>" е изравнено с "<LIGERO_MERGE_TO_TICKET>".',
