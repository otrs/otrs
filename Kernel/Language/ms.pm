...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to LIGERO Group in order to get better support.' =>
            'Adalah amat disyorkan untuk menghantar data ini kepada Kumpulan LIGERO dalam usaha untuk mendapatkan sokongan yang lebih baik. ',
        ...
        'This will allow the system to send additional support data information to LIGERO Group.' =>
            'Ini akan membolehkan sistem untuk menghantar maklumat tambahan data sokongan kepada Kumpulan LIGERO.',
        'Update' => 'Kemaskini',
        ...
        'To enable data sending, please register your system with LIGERO Group or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Untuk membolehkan data dihantar, sila daftar sistem anda dengan Kumpulan LIGERO atau kemas kini maklumat pendaftaran sistem anda (pastikan untuk mengaktif pilihan \'menghantar data sokongan\'.)',
        ...
        'System registration is a service of LIGERO Group, which provides a lot of advantages!' =>
            'Sistem pendaftaran ialah perkhirmatan Kumpulan LIGERO, yang memberikan banyak kelebihan!',
        'Please note that the use of LIGERO cloud services requires the system to be registered.' =>
            'Sila ambil perhatian bahawa penggunaan perkhidmatan cloud LIGERO memerlukan pendaftaran sistem.',
        'Register this system' => 'Daftar sistem ini',
        ...
        'This LIGERO invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Modul LIGERO invoker backend ini akan dipanggil untuk menyediakan data untuk dihantar ke sistem jauh, dan untuk memproses data respons.',
        ...
        'The data from the invoker of LIGERO will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Data dari invoker daripada LIGERO akan diproses oleh pemetaan ini, untuk mengubah kepada jenis data sistem jauh menjangka.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of LIGERO expects.' =>
            'Data tindak balas akan diproses oleh pemetaan ini, untuk mengubah kepada jenis data invoker jangkaan LIGERO.',
        ...
        'Asynchronous event triggers are handled by the LIGERO Scheduler Daemon in background (recommended).' =>
            'Pencetus peristiwa tidak selari dikendalikan oleh Penjadual Daemon LIGERO pada latar belakang (disyorkan).',
        ...
        'This LIGERO operation backend module will be called internally to process the request, generating data for the response.' =>
            'Operasi backend LIGERO ini akan dipanggil secara dalaman untuk memproses permintaan itu, menjana data untuk tidak balas.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data LIGERO expects.' =>
            'Data yang dipinta akan diproses oleh pemetaan ini, untuk mengubah ia kepada jenis data yang dijangka LIGERO.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that LIGERO will process.' =>
            'Di sini anda boleh menentukan saiz maksimum (dalam bait) mesej yang lain yang LIGERO akan proses .',
        ...
        'e.g https://www.ligero.com:10745/api/v1.0 (without trailing backslash)' =>
            'contoh https://www.ligero.com:10745/api/v1.0 (tanpa backslash berjela-jela)',
        'Timeout' => '',
        ...
        'e.g. /opt/ligero/var/certificates/SOAP/CA/ca.pem' => 'contoh: /opt/ligero/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/ligero/var/certificates/SOAP/CA' => 'contoh: /opt/ligero/var/certificates/SOAP/CA',
        ...
        'e.g urn:ligero-com:soap:functions or http://www.ligero.com/GenericInterface/actions' =>
            'contoh: urn:ligero-com:soap:functions or http://www.ligero.com/GenericInterface/actions',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that LIGERO will process.' =>
            'Di sini anda boleh menentukan saiz maksimum (dalam byte) mesej SOAP yang akan diproses oleh LIGERO.',
        'Encoding' => 'Pengekodan',
        ...
        'In provider mode, LIGERO offers web services which are used by remote systems.' =>
            'Dalam mod pembekal, LIGERO menawarkan perkhidmatan web yang digunakan oleh sistem jauh.',
        'In requester mode, LIGERO uses web services of remote systems.' =>
            'Dalam mod peminta, LIGERO menggunakan perkhidmatan web sistem terpencil.',
        ...
        '%s makes contact regularly with cloud.ligero.com to check on available updates and the validity of the underlying contract.' =>
            '%s membuat hubungan kerap dengan cloud.ligero.com untuk memeriksa kemas kini yang tersedia dan kesahihan kontrak asas.',
        ...
        'Connection to cloud.ligero.com via HTTPS couldn\'t be established. Please make sure that your LIGERO can connect to cloud.ligero.com via port 443.' =>
            'Sambungan ke cloud.ligero.com melalui HTTPS tidak dapat diwujudkan. Sila pastikan bahawa LIGERO anda boleh bersambung ke cloud.ligero.com melalui port 443.',
        ...
        'Go to LIGERO Package Manager' => 'Pergi ke Pengurus Pakej LIGERO',
        ...
        'To be able to use PGP in LIGERO, you have to enable it first.' => 'Untuk boleh menggunakan PGP dalam LIGERO, anda perlu membolehkannya terlebih dahulu.',
        ...
        'LIGERO Verify™ can not continue!' => 'LIGERO Verify™ tidak boleh diteruskan.',
        ...
        'This package is verified by LIGEROverify (tm)' => 'Pakej ini disahkan oleh LIGEROverify (tm)',
        ...
        'This system is registered with LIGERO Group.' => 'Sistem ini berdaftar dengan Kumpulan LIGERO.',
        ...
        'Please note that you can\'t register your system if LIGERO Daemon is not running correctly!' =>
            'Sila ambil perhatian bahawa anda tidak boleh mendaftar sistem jika LIGERO Daemon tidak berjalan dengan betul.',
        'Instructions' => 'Arahan',
        ...
        'LIGERO-ID Login' => 'LIGERO-Log masuk ID',
        'Read more' => 'Baca lagi',
        'You need to log in with your LIGERO-ID to register your system.' =>
            'Anda perlu log masuk dengan ID-LIGERO untuk mendaftar sistem anda.',
        'Your LIGERO-ID is the email address you used to sign up on the LIGERO.com webpage.' =>
            'ID-LIGERO anda ialah alamat emel yang anda gunakan untuk mendaftar pada laman web LIGERO.com.',
        ...
        'Can I use LIGERO without being registered?' => 'Bolehkah saya menggunakan LIGERO tanpa berdaftar?',
        'System registration is optional.' => 'Pendaftaran sistem adalah berpilihan.',
        'You can download and use LIGERO without being registered.' => 'Anda boleh memuat turun dan menggunakan LIGERO yang tidak berdaftar.',
        ...
        'A registered system sends the following data to LIGERO Group:' => 'Sistem yang berdaftar menghantar data berikut kepada Kumpulan LIGERO:',
        'Fully Qualified Domain Name (FQDN), LIGERO version, Database, Operating System and Perl version.' =>
            'Nama Domain Berkelayakan Penuh ( FQDN ), versi LIGERO, Pangkalan Data, Sistem pengendalian dan versi Perl.',
        ...
        'How often does my LIGERO system send updates?' => 'Berapa kerapkah sistem LIGERO saya menghantar berita terkini?',
        ...
        'You need to log in with your LIGERO-ID to deregister your system.' =>
            'Anda perlu untuk log masuk menggunakan ID-LIGERO anda untuk membatalkan pendaftaran sistem anda.',
        'LIGERO-ID' => 'ID-LIGERO',
        'You don\'t have an LIGERO-ID yet?' => 'Anda belum mempunyai ID-LIGERO?',
        ...
        'This data will be frequently transferred to LIGERO Group when you register this system.' =>
            'Data ini akan selalu dipindahkan ke Kumpulan LIGERO apabila anda mendaftar sistem ini.',
        'Attribute' => 'Sifat',
        'FQDN' => 'FQDN',
        ...
        'Continuing with this step will deregister the system from LIGERO Group.' =>
            'Melanjutkan langkah ini akan membatalkan pendaftaran sistem daripada Kumpulan LIGERO.',
        ...
        'To be able to use SMIME in LIGERO, you have to enable it first.' =>
            'Untuk boleh menggunakan SMIME dalam LIGERO, anda perlu membolehkannya terlebih dahulu.',
        ...
        'Sending support data to LIGERO Group is not possible!' => 'Menghantar data sokongan kepada Kumpulan LIGERO adalah tidak mungkin!',
        ...
        'This data is sent to LIGERO Group on a regular basis. To stop sending this data please update your system registration.' =>
            'Data ini dihantar kepada Kumpulan LIGERO secara tetap. Untuk berhenti menghantar data ini sila kemas kini pendaftaran sistem anda.',
        ...
        'The support bundle will be sent to LIGERO Group via email automatically.' =>
            'Berkas sokongan akan dihantar ke Kumpulan LIGERO melalui emel secara automatik.',
        'Download File' => 'Muat turun fail',
        'A file containing the support bundle will be downloaded to the local system. Please save the file and send it to the LIGERO Group, using an alternate method.' =>
            'Fail yang mengandungi berkas sokongan akan dimuat turun ke sistem domestik. Sila simpan fail dan hantarnya kepada Kumpulan LIGERO, menggunakan kaedah selang-seli.',
        ...
        'The LIGERO Daemon is a daemon process that performs asynchronous tasks, e.g. ticket escalation triggering, email sending, etc.' =>
            'LIGERO Daemon ialah proses daemon yang menjalankan tugas tidak segerak, contoh: cetusan peningkatan tiket, menghantar emel dan lain-lain.',
        'A running LIGERO Daemon is mandatory for correct system operation.' =>
            'LIGERO Daemon yang berjalan adalah wajib untuk operasi sistem yang betul.',
        'Starting the LIGERO Daemon' => 'Memulakan LIGERO Daemon',
        'Make sure that the file \'%s\' exists (without .dist extension). This cron job will check every 5 minutes if the LIGERO Daemon is running and start it if needed.' =>
            'Pastikan fail \'%s\' wujud (tanpa sambungan .dist). Tugas cron ini akan memeriksa setiap 5 minit jika LIGERO Daemon sedang berjalan dan memulakan apabila diperlukan.',
        'Execute \'%s start\' to make sure the cron jobs of the \'ligero\' user are active.' =>
            'Jalankan \'%s mula\' untuk memastikan tugas cron pengguna \'ligero\' aktif.',
        'After 5 minutes, check that the LIGERO Daemon is running in the system (\'bin/ligero.Daemon.pl status\').' =>
            'Selepas 5 minit, periksa LIGERO Deamon yang berjalan di dalam sistem (\'bin/ligero.Daemon.pl status\').',
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating LIGERO at %s.' => 'Adakah anda tahu? Anda boleh membantu menterjemahkan LIGERO di %s.',
        ...
        'Create a new database for LIGERO' => 'Cipta pangkalan data baharu untuk LIGERO',
        'Use an existing database for LIGERO' => 'Guna pangkalan data sedia ada untuk LIGERO',
        ...
        'A new database user with limited permissions will be created for this LIGERO system.' =>
            'Seorang pengguna pangkalan data baru dengan keistimewaan yang terhad dicipta pada sistem LIGERO ini.',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Untuk menggunakan LIGERO, mesti masukkan baris berikut sebagai root pada baris arahan (terminal / shell).',
        'Restart your webserver' => 'Mulakan semula webserver anda.',
        'After doing so your LIGERO is up and running.' => 'Selepas berbuat demikian LIGERO anda akan bersedia untuk dijalankan',
        'Start page' => 'Halaman mula',
        'Your LIGERO Team' => 'Team LIGERO anda',
        ...
        'Sorry, but this feature of LIGERO is currently not available for mobile devices. If you\'d like to use it, you can either switch to desktop mode or use your regular desktop device.' =>
            'Maaf, ciri LIGERO ini tidak tersedia pada masa sekarang untuk mod telefon bimbit. Jika anda ingin menggunakannya, anda boleh sama ada menukar ke mod komputer atau gunakan alat komputer biasa.',
        ...
        'This is the default public interface of LIGERO! There was no action parameter given.' =>
            'Ini adalah antara muka awam lalai bagi LIGERO! Tidak terdapat pada parameter yang diberikan.',
        ...
        # Template: Test
        'LIGERO Test Page' => 'Halaman percubaan LIGERO',
        'Unlock' => 'Membuka',
        ...
        'ACLs could not be Imported due to a unknown error, please check LIGERO logs for more information' =>
            'ACLs tidak boleh diimport kerana kesalahan yang tidak dapat dikenalpasti, sila semak log LIGERO untuk maklumat lanjut',
        ...
        'LIGERO as provider' => 'LIGERO sebagai pembekal',
        'Operations' => 'Operasi',
        'LIGERO as requester' => 'LIGERO sebagai peminta',
        'Invokers' => '',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'Pakej tidak disahkan oleh Kumpulan LIGERO! Ia adalah disyorkan untuk tidak menggunakan pakej ini.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Install LIGERO' => 'Memasang LIGERO',
        'Intro' => 'Permulaan',
        ...
        'Enable cloud services to unleash all LIGERO features!' => 'Membolehkan servis awan untuk mengeluarkan semua ciri-ciri LIGERO!',
        ...
        'LIGERO Disk Partition' => 'Pembahagian Cakera LIGERO',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Penggunaan cakera',
        'The partition where LIGERO is located is almost full.' => 'Pembahagian di mana LIGERO diletakkan hampir penuh.',
        'The partition where LIGERO is located has no disk space problems.' =>
            'Pembahagian di mana LIGERO diletakkan tidak mempunyai masalah ruangan cakera.',
        ...
        'The file system on your LIGERO partition is not writable.' => 'Sistem fail pada bahagian LIGERO anda tidak boleh ditulis.',
        ...
        'Table ticket_lock_index contains orphaned records. Please run bin/ligero.Console.pl "Maint::Ticket::QueueIndexCleanup" to clean the StaticDB index.' =>
            'Jadual ticket_lock_index mengandungi rekod piatu. Sila jalankan bin/ligero.Console.pl "Maint::Ticket::QueueIndexCleanup" untuk membersihkan indeks StaticDB.',
        ...
        'LIGERO requires apache to be run with the \'prefork\' MPM model.' =>
            'LIGERO memerlukan apache dijalankan dengan model MPM \'prefork\'.',
        ...
        'Information about the LIGERO Daemon' => 'Informasi mengenai LIGERO Daemon',
...
',
        ...
        'Adds a suffix with the actual year and month to the LIGERO log file. A logfile for every month will be created.' =>
            'Tambah akhiran dengan tahun sebenar dan bulan untuk fail log LIGERO. Satu fail log bagi setiap bulan akan diwujudkan.',
...
dalaman.',
        ...
        'Basic fulltext index settings. Execute "bin/ligero.Console.pl Maint::Ticket::FulltextIndexRebuild" in order to generate a new index.' =>
            'Tetapan asas indeks tekspenuh. Jalankan "bin/ligero.Console.pl Maint::Ticket::FulltextIndexRebuild" dalam usaha untuk menghasilkan indeks baharu.',
        ...
        'Checks the availability of LIGERO Business Solution™ for this system.' =>
            'Periksa ketersediaan Penyelesaian Bisnes LIGERO™ untuk sistem ini.',
        'Checks the entitlement status of LIGERO Business Solution™.' => 'Periksa status hak Penyelesaian Bisnes LIGERO™.',
        'Child' => 'Child',
        ...
        'Configure sending of support data to LIGERO Group for improved support.' =>
            'Konfigurasi penghantaran data sokongan kepada Kumpulan LIGERO untuk sokongan yang lebih baik.',
        ...
        'Configures a default TicketDynamicField setting. "Name" defines the dynamic field which should be used, "Value" is the data that will be set, and "Event" defines the trigger event. Please check the developer manual (http://ligero.github.io/doc/), chapter "Ticket Event Module".' =>
            'Mengkonfigurasi tetapan TicketDynamicField default. "Nama" mentakrifkan bidang dinamik yang sepatutnya digunakan, "Nilai" adalah data yang akan diset, dan "Event" mentakrifkan peristiwa pencetus. Sila semak manual pemaju (http://ligero.github.io/doc/), bab "Tiket Acara Modul".',
        ...
        'Define a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Mentakrif tapisan untuk output html untuk menambah pautan di sebalik takrifan yang berkait. Imej unsur membolehkan 2 jenis input. Sekaligus nama sesuatu imej (Contohnya faq.png). Dalam kes ini laluan imej LIGERO akan digunakan. Kemungkinan kedua adalah untuk memasukkan pautan kepada imej.',
        ...
        'Defines a filter for html output to add links behind CVE numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Mentakrifkan tapisan untuk output html untuk menambah pautan di belakang nombor CVE. Imej unsur membolehkan dua jenis input. Sekaligus nama satu imej (contoh faq.png). Dalam kes ini laluan imej LIGERO akan digunakan. Kemungkinan yang kedua adalah memasukkan pautan pada imej.',
        'Defines a filter for html output to add links behind MSBulletin numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Mentakrifkan tapisan untuk output html untuk menambah pautan di belakang nombor MSBulletin. Imej unsur membolehkan dua jenis input. Sekaligus nama satu imej (contoh faq.png). Dalam kes ini laluan imej LIGERO akan digunakan. Kemungkinan yang kedua adalah memasukkan pautan pada imej.',
        'Defines a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Mentakrifkan tapisan untuk output html untuk menambah pautan di belakang string yang ditakrifkan. Imej unsur membolehkan dua jenis input. Sekaligus nama satu imej (contoh faq.png). Dalam kes ini laluan imej LIGERO akan digunakan. Kemungkinan yang kedua adalah memasukkan pautan pada imej.',
        'Defines a filter for html output to add links behind bugtraq numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Mentakrifkan tapisan untuk output html untuk menambah pautan di belakang nombor bugtraq. Imej unsur membolehkan dua jenis input. Sekaligus nama satu imej (contoh faq.png). Dalam kes ini laluan imej LIGERO akan digunakan. Kemungkinan yang kedua adalah memasukkan pautan pada imej.',
        ...
        'Defines the default front-end (HTML) theme to be used by the agents and customers. If you like, you can add your own theme. Please refer the administrator manual located at http://ligero.github.io/doc/.' =>
            'Mentakrifkan tema (HTML) bahagian depan default yang akan digunakan oleh ejen-ejen dan pelanggan. Jika anda suka, anda boleh menambah tema anda sendiri. Sila rujuk manual pentadbir yang terletak di http://ligero.github.io/doc/.',
...
Search_DynamicField_XTimeSlotStartMonth=01; Search_DynamicField_XTimeSlotStartDay=26; Search_DynamicField_XTimeSlotStartHour=00; Search_DynamicField_XTimeSlotStartMinute=00; Search_DynamicField_XTimeSlotStartSecond=00; Search_DynamicField_XTimeSlotStopYear=2013; Search_DynamicField_XTimeSlotStopMonth=01; Search_DynamicField_XTimeSlotStopDay=26; Search_DynamicField_XTimeSlotStopHour=23; Search_DynamicField_XTimeSlotStopMinute=59; Search_DynamicField_XTimeSlotStopSecond=59;\' and or \'Search_DynamicField_XTimePointFormat=week; Search_DynamicField_XTimePointStart=Before; Search_DynamicField_XTimePointValue=7\';.',
        ...
        'Defines the fully qualified domain name of the system. This setting is used as a variable, LIGERO_CONFIG_FQDN which is found in all forms of messaging used by the application, to build links to the tickets within your system.' =>
            'Mentakrifkan nama domain sistem yang layak sepenuhnya. Tetapan ini digunakan sebagai pembolehubah, LIGERO_CONFIG_FQDN dimana ia wujud dalam beberapa bentuk mesej yang digunakan oleh aplikasi itu.',
        ...
        'Defines the list of online repositories. Another installations can be used as repository, for example: Key="http://example.com/ligero/public.pl?Action=PublicRepository;File=" and Content="Some Name".' =>
            'Mentakifkan senarai repositori dalam talian. Pemasangan lain boleh digunakan sebagai repositori, contoh seperti: Key="http://example.com/ligero/public.pl?Action=PublicRepository;File=" and Content="Some Name".',
        ...
        'Defines the maximal size (in bytes) for file uploads via the browser. Warning: Setting this option to a value which is too low could cause many masks in your LIGERO instance to stop working (probably any mask which takes input from the user).' =>
            'Mentakrifkan saiz maksimum (dalam byte) untuk muat naik fail melalui pelayar. Amaran: Menetapkan pilihan ini kepada nilai yang terlalu rendah boleh menyebabkan banyak topeng dalam hal LIGERO anda berhenti kerja (mungkin apa-apa topeng yang mengambil input daripada pengguna).',
        ...
        'Defines the module to display a notification in different interfaces on different occasions for LIGERO Business Solution™.' =>
            'Mentakrifkan modul untuk memaparkan pemberitahuan dalam antara muka yang berbeza pada masa yang berlainan bagi Penyelesaian LIGERO™.',
        'Defines the module to display a notification in the agent interface if the LIGERO Daemon is not running.' =>
            'Mentakrifkan modul untuk memaparkan pemberitahuan dalam antara muka ejen jika LIGERO Daemon tidak berjalan.',
        ...
        'Defines the name of the session key. E.g. Session, SessionID or LIGERO.' =>
            'Mentakrifkan nama kunic sesi. Contoh: Session, SessionID atau LIGERO.',
        ...
        'Defines the system identifier. Every ticket number and http session string contains this ID. This ensures that only tickets which belong to your system will be processed as follow-ups (useful when communicating between two instances of LIGERO).' =>
            'Mentakrifkan pengecam sistem. Setiap nombor tiket dan sesi http rentetan mengandungi ID ini. Ini memastikan bahawa hanya tiket yang tergolong dalam sistem anda akan diproses susulan (berguna apabila berkomunikasi antara dua contoh LIGERO).',
        ...
        'Defines the valid states for unlocked tickets. To unlock tickets the script "bin/ligero.Console.pl Maint::Ticket::UnlockTimeout" can be used.' =>
            'Mentakrifkan keadaan sah untuk tiket dibuka. Untuk membuka kunci tiket skrip "bin/ligero.Console.pl Maint::Tiket::UnlockTimeout" yang boleh digunakan.',
        ...
        'Delivers extended debugging information in the frontend in case any AJAX errors occur, if enabled.' =>
            '',
        'Deploy and manage LIGERO Business Solution™.' => 'Menggerakkan dan menguruskan Penyelesaian Bisnes LIGERO™.',
        'Detached' => '',
        ...
        'Disable HTTP header "X-Frame-Options: SAMEORIGIN" to allow LIGERO to be included as an IFrame in other websites. Disabling this HTTP header can be a security issue! Only disable it, if you know what you are doing!' =>
            'Menyahaktif header HTTP "Pilihan Bingkai-X: SAMEORIGIN" untuk membenarkan LIGERO untuk dimasukkan sebagai IFrame dalam laman web lain. Menyahaktifkan header HTTP ini boleh menjadi isu keselamatan! Hanya nyahaktifkannya, jika anda tahu apa yang anda lakukan!',
        ...
        'Enables PGP support. When PGP support is enabled for signing and encrypting mail, it is HIGHLY recommended that the web server runs as the LIGERO user. Otherwise, there will be problems with the privileges when accessing .gnupg folder.' =>
            'Mendayakan sokongan PGP. Apabila sokongan PGP didayakan untuk menandatangani dan mengekodkan mel, ia amat disyorkan bahawa pelayan web dijalankan sebagai pengguna LIGERO. Jika tidak, akan ada masalah dengan keistimewaan semasa mengakses fail .gnupg.',
        ...
        'Filter for debugging ACLs. Note: More ticket attributes can be added in the format <LIGERO_TICKET_Attribute> e.g. <LIGERO_TICKET_Priority>.' =>
            'Tapisan untuk nyahpepijat ACLs. Nota: Lebih sifat tiket boleh ditambah dalam format <LIGERO_TICKET_Attribute> contoh: <LIGERO_TICKET_Priority>.',
        'Filter for debugging Transitions. Note: More filters can be added in the format <LIGERO_TICKET_Attribute> e.g. <LIGERO_TICKET_Priority>.' =>
            'Tapisan untuk nyahpepijat Peralihan: Lebih sifat tiket boleh ditambah dalam format <LIGERO_TICKET_Attribute> contoh: <LIGERO_TICKET_Priority>.',
        ...
        'If "LDAP" was selected for Customer::Authmodule, you can check if the user is allowed to authenticate because he is in a posixGroup, e.g. user needs to be in a group xyz to use LIGERO. Specify the group, who may access the system.' =>
            'Jika "LDAP" dipilih untuk Customer::AuthModule, anda boleh semak jika pengguna dibenarkan untuk mengesahkan sebab pengguna tersebut berada dalam posixGroup, cth: pengguna perlu berada di dalam kumpulan xyz untuk gunaLIGERO. Tentukan kumpulan tersebut, siapa yang boleh akses sistem tersebut.',
        ...
        'If enabled, LIGERO will deliver all JavaScript files in minified form.' =>
            'Jika diakifkan, LIGERO akan menghantar kesemua fail JavaScript dalam bentuk yang dikecilkan.',
        ...
        'Malay' => 'Melayu',
        'Manage LIGERO Group cloud services.' => 'Uruskan perkhidmatan cloud Kumpulan LIGERO.',
        ...
        'Merged Ticket <LIGERO_TICKET> to <LIGERO_MERGE_TO_TICKET>.' => 'Gabung Tiket <LIGERO_TICKET> ke <LIGERO_MERGE_TO_TICKET>.',
        'Minute' => '',
        ...
        'News about LIGERO releases!' => 'Berita mengenai pengeluaran LIGERO!',
        'News about LIGERO.' => '',
        ...
        'LIGERO can use one or more readonly mirror databases for expensive operations like fulltext search or statistics generation. Here you can specify the DSN for the first mirror database.' =>
            'LIGERO boleh menggunakan salah satu atau lebih pangkalan data cermin baca sahaja untuk operasi mahal seperti carian atau statistik teks penuh generasi. Di sini anda boleh menentukan DSN untuk pangkalan data cermin pertama.',
        ...
        'Reports' => 'Laporan',
        'Reports (LIGERO Business Solution™)' => 'Proses (Penyelesaian Bisnes LIGERO™)',
        ...
        'Saves the attachments of articles. "DB" stores all data in the database (not recommended for storing big attachments). "FS" stores the data on the filesystem; this is faster but the webserver should run under the LIGERO user. You can switch between the modules even on a system that is already in production without any loss of data. Note: Searching for attachment names is not supported when "FS" is used.' =>
            'Menyimpan lampiran artikel. "DB" menyimpan semua data dalam pangkalan data (tidak digalakkan untuk menyimpan lampiran besar). "FS" menyimpan data pada sistem fail, ini adalah lebih cepat tetapi server web perlu dijalankan di bawah pengguna LIGERO itu. Anda boleh bertukar antara modul walaupun pada satu sistem yang sudah dalam pengeluaran tanpa kehilangan data. Nota: Carian untuk nama lampiran tidak disokong apabila "FS" digunakan.',
        ...
        'Sends registration information to LIGERO group.' => 'Hantar maklumat pendaftaran kepada kumpulan LIGERO.',
        ...
        'Sets the prefix to the scripts folder on the server, as configured on the web server. This setting is used as a variable, LIGERO_CONFIG_ScriptAlias which is found in all forms of messaging used by the application, to build links to the tickets within the system.' =>
            'Set prefiks untuk folder skrip pada server, seperti yang dikonfigurasikan pada server web. Tetapan ini digunakan sebagai pembolehubah, LIGERO_CONFIG_ScriptAlias ​​yang terdapat dalam semua bentuk pesanan yang digunakan oleh aplikasi, untuk membina hubungan tiket dalam sistem.',
        ...
        'Shows information on how to start LIGERO Daemon' => 'Menunjukkan maklumat untuk memulakan LIGERO Daemon.',
        ...
        'Specifies the email address that should be used by the application when sending notifications. The email address is used to build the complete display name for the notification master (i.e. "LIGERO Notifications" ligero@your.example.com). You can use the LIGERO_CONFIG_FQDN variable as set in your configuation, or choose another email address.' =>
            'Menentukan alamat emel yang harus digunakan oleh permohonan penghantaran pemberitahuan. Alamat emel digunakan untuk membina nama paparan lengkap untuk pemberitahuan master (contoh: "LIGERO Notifications" ligero@your.example.com). Anda boleh menggunakan pemboleh ubah LIGERO_CONFIG_FQDN seperti diset dalam konfigurasi anda, atau memilih alamt emel yang lain.',
        ...
        'Specifies the name that should be used by the application when sending notifications. The sender name is used to build the complete display name for the notification master (i.e. "LIGERO Notifications" ligero@your.example.com).' =>
            'Menentukan nama yang harus digunakan oleh permohonan apabila menghantar pemberitahuan. Nama penghantar digunakan untuk membina nama paparan lengkap untuk pemberitahuan master (contoh: "LIGERO Notifications" ligero@your.example.com).',
        ...
        'Specify the channel to be used to fetch LIGERO Business Solution™ updates. Warning: Development releases might not be complete, your system might experience unrecoverable errors and on extreme cases could become unresponsive!' =>
            'Berikan butir saluran untuk digunakan untuk memperoleh kemaskini Solusi Bisnes LIGERO™. Amaran: Pelepasan pembangunan mungkin tidak lengkap, sistem anda mungkin mengalami ralat yang tidak diliputi dan dalam kes yang ekstrem mungkin tidak bertindak balas.',
        ...
        'Toggles display of LIGERO FeatureAddons list in PackageManager.' =>
            'Bertukar-tukar paparan senarai LIGERO FeatureAddons dalam PackageManager.',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is bounced to "<LIGERO_BOUNCE_TO>". Contact this address for further information.' =>
            'Emel anda dengan nombor tiket "<LIGERO_TICKET>" dilantunkan ke "<LIGERO_BOUNCE_TO>".  Hubungi alamat ini untuk maklumat lanjut. ',
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Emel anda dengan nombor tiket "<LIGERO_TICKET>" adalah digabungkan kepada "<LIGERO_MERGE_TO_TICKET>"!',
