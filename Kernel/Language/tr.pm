...
sub Data {
    ...
    $Self->{Completeness}        = 0.195398351648352;
    ...
    $Self->{Translation} = {
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'LIGERO\'yi kullanabilmek için komut satırında (konsol/kabuk/terminal) root kullanıcısı olarak şu satırı girmelisiniz.',
        'Restart your webserver' => 'Web sunucunuzu yeniden başlatın.',
        'After doing so your LIGERO is up and running.' => 'Bunu yaptıktan sonra LIGERO çalışıyor olacak.',
        'Start page' => 'Başlangıç sayfası',
        'Your LIGERO Team' => 'LIGERO Takımınız',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO Test Sayfası',
        'Unlock' => 'Kilidi Aç',
        'Welcome %s %s' => '',
        'Counter' => 'Sayaç',
...
' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            '"<LIGERO_TICKET>" bilet numaralı e-postanız "<LIGERO_MERGE_TO_TICKET>" ile birleştirildi.',
