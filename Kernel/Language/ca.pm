...
sub Data {
    ...
    $Self->{Completeness}        = 0.22081043956044;
    ...
    $Self->{Translation} = {
        ...
        'This LIGERO invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Aquest mòdul del motor de l\'invocador de LIGERO es dirà per preparar les dades per ser enviats al sistema remot, i per processar les seves dades de resposta.',
        ...
        'The data from the invoker of LIGERO will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Les dades de l\'invocador de LIGERO seran processats ​​per aquesta assignació, per transformar-la en el tipus de dades que el sistema remot espera.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of LIGERO expects.' =>
            'Les dades de resposta seran processats per aquesta assignació, per transformar-los en el tipus de dades que l\'invocador de LIGERO espera.',
        ...
        'Notifications (LIGERO Business Solution™)' => 'Notificacions (LIGERO Solucions empresarials)',
        'Personal preferences' => '',
        ...
        'A new database user with limited permissions will be created for this LIGERO system.' =>
            'Un nou usuari de base de dades amb drets limitats serà creat per a aquest sistema LIGERO.',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Per a poder utilitzar LIGERO ha d\'escriure la següent linea de comandos (Terminal/Shell) com root',
        'Restart your webserver' => 'Reiniciï el seu servidor web',
        'After doing so your LIGERO is up and running.' => 'Després de fer això el seu LIGERO estarà actiu i executant-se',
        'Start page' => 'Pàgina d\'inici',
        'Your LIGERO Team' => 'El seu equip LIGERO',
        ...
        # Template: Test
        'LIGERO Test Page' => 'Pàgina de prova de LIGERO ',
        'Unlock' => 'Desbloquejar',
        'Welcome %s %s' => '',
        'Counter' => 'Comptador',
        ...
        'Install LIGERO' => 'Instal·lar LIGERO',
        'Intro' => 'Intro',
...
' => '',
        ...
        'Adds a suffix with the actual year and month to the LIGERO log file. A logfile for every month will be created.' =>
            'Afegeix un sufix amb l\'any actual i el mes en el fitxer de registre de LIGERO. Es crearà un arxiu per cada mes.',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Noves versions d\'LIGERO publicades!',
        'News about LIGERO.' => '',
        ...
        'LIGERO News' => 'Novetats de LIGERO',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'El seu correu amb nombre de tiquet "<LIGERO_TICKET>" es va unir a "<LIGERO_MERGE_TO_TICKET>".',
