...
sub Data {
    ...
    $Self->{Completeness}        = 0.20467032967033;
    ...
    $Self->{Translation} = {
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Voidaksesi käyttää LIGERO-järjestelmää tulee sinun kirjoittaa seuraava komento root oikeuksilla komentokehotteessa.',
        'Restart your webserver' => 'Käynnistä web-palvelin uudestaan',
        'After doing so your LIGERO is up and running.' => 'Tämän jälkeen LIGERO järjestelmä on käytettävissä.',
        'Start page' => 'Aloitussivu',
        'Your LIGERO Team' => 'LIGERO Tiimi',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO - Testisivu',
        ...
        'LIGERO as provider' => 'LIGERO antaa tietoja',
        'Operations' => '',
        'LIGERO as requester' => 'LIGERO pyytää tietoja',
        'Invokers' => '',
...
' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Sähköpostisi tikettinumerolla "<LIGERO_TICKET>" on liitetty tikettiin "<LIGERO_MERGE_TO_TICKET>".',
