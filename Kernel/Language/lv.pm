...
sub Data {
    ...
    $Self->{Completeness}        = 0.167239010989011;
    ...
    $Self->{Translation} = {
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Lai varētu izmantot LIGERO, sekojošā komanda jāizpilda terminālī/čaulā.',
        'Restart your webserver' => 'Pārstartējiet tīmekļa serveri (webserver).',
        'After doing so your LIGERO is up and running.' => 'Pēc tam LIGERO būs darba kārtībā un palaists.',
        'Start page' => 'Sākumlapa',
        'Your LIGERO Team' => 'Jūsu LIGERO komanda',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO problēmu pieteikumu sistēmas testa lapa',
        'Unlock' => 'Atslēgt',
        'Welcome %s %s' => '',
        'Counter' => 'Skaitītājs',
        ...
        'LIGERO as provider' => '',
        'Operations' => '',
        'LIGERO as requester' => 'LIGERO kā pieprasītājs',
        'Invokers' => '',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'Pakete nav pārbaudīta ar LIGERO Group! Nav ieteicams izmantot šo paketi.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Install LIGERO' => 'Instalējiet LIGERO',
        'Intro' => '',
        ...
        'Enable cloud services to unleash all LIGERO features!' => '',
        ...
        'LIGERO Disk Partition' => 'LIGERO diska nodalījums',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Diska lietojums',
        'The partition where LIGERO is located is almost full.' => 'Nodalījums, kurā atrodas LIGERO ir gandrīz pilns.',
        'The partition where LIGERO is located has no disk space problems.' =>
            'Nodalījums, kurā atrodas LIGERO nav diska vietas problēmas.',
        ...
        'The file system on your LIGERO partition is not writable.' => '',
...
' => '',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Ziņas par LIGERO relīzēm!',
        'News about LIGERO.' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Jūsu e-pasts ar pieteikuma numuru "<LIGERO_TICKET>" ir apvienots ar pieteikumu nr. "<LIGERO_MERGE_TO_TICKET>"!',
