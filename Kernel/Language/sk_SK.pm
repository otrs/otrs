...
sub Data {
    ...
    $Self->{Completeness}        = 0.184752747252747;
    ...
    $Self->{Translation} = {
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating LIGERO at %s.' => 'Vedeli ste že aj Vy možete pomôcť s prekladaním LIGERO na %s.',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Aby ste mohli pouzivat LIGERO =>  musite zadat nasledovne: do Vasho prikazoveho riadku (terminal/shell) =>  pricom musite byt prihlaseny ako root:',
        'Restart your webserver' => 'dat "nasledovne") do Vasho prikazoveho riadku (terminal/shell) =>  pricom musite byt prihlaseny ako root:',
        'After doing so your LIGERO is up and running.' => 'Ak to urobíte =>  Váš LIGERO je spustený.',
        'Start page' => 'Prvá strana',
        'Your LIGERO Team' => 'Váš LIGERO tím',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO test stránka',
        'Unlock' => 'Odomknúť',
        ...
        'LIGERO as provider' => 'LIGERO ako provider',
        'Operations' => '',
        'LIGERO as requester' => 'LIGERO ako žiadateľ',
        'Invokers' => '',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'Balík nie je overený LIGERO skupinou. Neodporúča sa používať tento balík.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Install LIGERO' => 'Inštalácia LIGERO',
        'Intro' => 'Úvod',
        ...
        'LIGERO Daemon is not running.' => 'LIGERO démon nebeží.',
...
' => '',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Novinky o LIGERO vydaniach!',
        'News about LIGERO.' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Váš e-mail na tikete číslo "<LIGERO_TICKET>" bol zlúčený do "<LIGERO_MERGE_TO_TICKET>".',
