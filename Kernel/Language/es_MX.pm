...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to LIGERO Group in order to get better support.' =>
            'Se recomienda ampliamente que envié estos datos al Grupo LIGERO con el fin de obtener un mejor soporte.',
        ...
        'This will allow the system to send additional support data information to LIGERO Group.' =>
            'Esto permitirá al sistema enviar información de datos adicionales de soporte al Grupo LIGERO.',
        'Update' => 'Actualizar',
        ...
        'To enable data sending, please register your system with LIGERO Group or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Para habilitar el envío de datos, registre su sistema con Grupo LIGERO o actualice la información de registro de su sistema ( asegúrese de activar la opción \'enviar datos de soporte\'.)',
        ...
        'System registration is a service of LIGERO Group, which provides a lot of advantages!' =>
            '!El registro del sistema es un servicio de Grupo LIGERO, el cual provee innumerables ventajas!',
        ...
        'Asynchronous event triggers are handled by the LIGERO Scheduler Daemon in background (recommended).' =>
            'Los disparadores de evento asíncronos son manejados por el Demonio Planificador de LIGERO en segundo plano (recomendado).',
        ...
        'Go to the LIGERO customer portal' => 'Ir al portal de clientes de LIGERO',
        ...
        'Go to LIGERO Package Manager' => 'Ir al Gestor de Paquetes LIGERO',
        ...
        'LIGERO Verify™ can not continue!' => '¡LIGERO Verity™ no puede continuar!',
        ...
        'This package is verified by LIGEROverify (tm)' => 'Este paquete esta verificado por LIGEROVerify (tm)',
        ...
        'This system is registered with LIGERO Group.' => 'Este sistema se encuentra registrado con Grupo LIGERO',
        ...
        'Please note that you can\'t register your system if LIGERO Daemon is not running correctly!' =>
            'Tenga en cuenta que no puede registrar su sistema si el Demonio de LIGERO no está funcionando correctamente!',
        ...
        'You need to log in with your LIGERO-ID to register your system.' =>
            'Necesita iniciar sesión con su LIGERO-ID para registrar su sistema.',
        'Your LIGERO-ID is the email address you used to sign up on the LIGERO.com webpage.' =>
            'Su LIGERO-ID es la dirección de email que utilizó para registrarse en la página web LIGERO.com',
        ...
        'The LIGERO Daemon is a daemon process that performs asynchronous tasks, e.g. ticket escalation triggering, email sending, etc.' =>
            'El Servicio LIGERO es un proceso de servicio que efectúa tareas asíncronas, por ejemplo disparo de escalada de tickets, envío de emails, etc.',
        'A running LIGERO Daemon is mandatory for correct system operation.' =>
            'Es indispensable que el Demonio de LIGERO esté ejecutándose para que el sistema opere correctamente.',
        'Starting the LIGERO Daemon' => 'Iniciando el Demonio de LIGERO',
        ...
        'A new database user with limited permissions will be created for this LIGERO system.' =>
            'Un usuario nuevo, con permisos limitados, se creará en este sistema LIGERO, para la base de datos.',
        ...
        'Sorry, but this feature of LIGERO is currently not available for mobile devices. If you\'d like to use it, you can either switch to desktop mode or use your regular desktop device.' =>
            'Lo sentimos, pero LIGERO no tiene disponible esta característica para dispositivos móviles. Si aún desea usar la dicha característica, puede hacerlo en el modo escritorio o puede usar una laptop o equipo de escritorio.',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'El paquete no ha sido verificado por el Grupo LIGERO! Se recomienda no utilizar este paquete.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Enable cloud services to unleash all LIGERO features!' => 'Habilite servicios en la nube para desencadenar todas las características de LIGERO!',
        ...
        'LIGERO Daemon is not running.' => 'El Demonio de LIGERO no está en ejecución.',
        ...
        'LIGERO Disk Partition' => 'Partición en disco para LIGERO',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Uso del disco',
        'The partition where LIGERO is located is almost full.' => 'La partición donde se encuentra localizado LIGERO está casi llena.',
        'The partition where LIGERO is located has no disk space problems.' =>
            'La partición donde se encuentra LIGERO no tiene problemas de espacioen disco.',
        ...
        'This option is currently disabled because the LIGERO Daemon is not running.' =>
            'Esta opción se encuentra actualmente deshabilitada debido a que el Demonio de LIGERO no está en ejecución.',
        ...
        'Information about the LIGERO Daemon' => 'Información acerca del Demonio de LIGERO',
...
' => '',
        ...
        'Adds a suffix with the actual year and month to the LIGERO log file. A logfile for every month will be created.' =>
            'Añade un sufijo con el año y mes actuales al archivo log de LIGERO. Se generará un archivo log distinto para cada mes.',
        ...
        'Define a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Define un filtro para la salida html para añadir vínculos a ciertas cadenas. El elemento Imagen permite dos tipos de entrada: un nombre de imagen (por ejemplo: faq.png). En este caso, se usa la ruta de imágenes de LIGERO. La otra posibilidad es insertar el vínculo a la imagen.',
        ...
        'Defines a filter for html output to add links behind CVE numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Define un filtro para salida html para añadir vínculos a los números CVE. El elemento Imagen permite dos tipos de entrada: un nombre de imagen (por ejemplo: faq.png). En este caso, se usa la ruta de imágenes de LIGERO. La otra posibilidad es insertar el vínculo a la imagen.',
        'Defines a filter for html output to add links behind MSBulletin numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Define un filtro para salida html para añadir vínculos a los números MSBulletin. El elemento Imagen permite dos tipos de entrada: un nombre de imagen (por ejemplo: faq.png). En este caso, se usa la ruta de imágenes de LIGERO. La otra posibilidad es insertar el vínculo a la imagen.',
        'Defines a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Define un filtro para salida html para añadir vínculos a una cadena definida. El elemento Imagen permite dos tipos de entrada: un nombre de imagen (por ejemplo: faq.png). En este caso, se usa la ruta de imágenes de LIGERO. La otra posibilidad es insertar el vínculo a la imagen.',
        'Defines a filter for html output to add links behind bugtraq numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Define un filtro para salida html para añadir vínculos a los números bugtraq. El elemento Imagen permite dos tipos de entrada: un nombre de imagen (por ejemplo: faq.png). En este caso, se usa la ruta de imágenes de LIGERO. La otra posibilidad es insertar el vínculo a la imagen.',
        ...
        'Defines the fully qualified domain name of the system. This setting is used as a variable, LIGERO_CONFIG_FQDN which is found in all forms of messaging used by the application, to build links to the tickets within your system.' =>
            'Define el nombre del dominio totalmente calificado del sistema. Esta configuración es usada como la variable LIGERO_CONFIG_FQDN, misma que se encuentra en todos los tipos de mensajes usados en la aplicación, para construir vínculos a los tickets del sistema.',
        ...
        'Defines the name of the session key. E.g. Session, SessionID or LIGERO.' =>
            'Define el nombre de las llaves de sesión. Por ejemplo: Sesión, SesiónID u LIGERO.',
        ...
        'If "LDAP" was selected for Customer::Authmodule, you can check if the user is allowed to authenticate because he is in a posixGroup, e.g. user needs to be in a group xyz to use LIGERO. Specify the group, who may access the system.' =>
            'Si "LDAP" se eligió como Customer::AuthModule, puede verificarse si al usuario se le permite autenticarse por estar en un GrupoPosix, por ejemplo: el usuario tiene que estar en el grupo xyz para usar LIGERO. Especifique el grupo que puede acceder al sistema.',
        ...
        'If enabled, LIGERO will deliver all JavaScript files in minified form.' =>
            'Si se habilita, LIGERO entregará todos los archivos JavaScript en forma reducida (minified).',
        ...
        'News about LIGERO releases!' => '¡Noticias sobre lanzamientos de LIGERO!',
        'News about LIGERO.' => '',
        ...
        'LIGERO News' => 'Novedades de LIGERO',
        ...
        'Sends registration information to LIGERO group.' => 'Enviar información de registro a Grupo LIGERO.',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Su correo con número de ticket "<LIGERO_TICKET>" se unió a "<LIGERO_MERGE_TO_TICKET>".',
