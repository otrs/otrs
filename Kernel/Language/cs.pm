...
sub Data {
    ...
    $Self->{Completeness}        = 0.207760989010989;
    ...
    $Self->{Translation} = {
        ...
        'The full path and name of the certification authority certificate file that validates SSL certificate.' =>
            '',
        'e.g. /opt/ligero/var/certificates/SOAP/CA/ca.pem' => '',
        ...
        'This system is registered with LIGERO Group.' => '',
        'System type' => '',
        'Unique ID' => '',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use LIGERO without being registered?' => '',
        'System registration is optional.' => '',
        'You can download and use LIGERO without being registered.' => '',
        'Is it possible to deregister?' => '',
        'You can deregister at any time.' => '',
        'Which data is transfered when registering?' => '',
        'A registered system sends the following data to LIGERO Group:' => '',
        ...
        'The description and system type you specify help you to identify and manage the details of your registered systems.' =>
            '',
        'How often does my LIGERO system send updates?' => '',
        ...
        'You need to log in with your LIGERO-ID to deregister your system.' =>
            '',
        'LIGERO-ID' => '',
        'You don\'t have an LIGERO-ID yet?' => '',
        'Sign up now' => '',
        ...
        'Really a bug? 5 out of 10 bug reports result from a wrong or incomplete installation of LIGERO.' =>
            'Opravdu chyba? 5 z 10 hlášení o chybách je důsledek nesprávné nebo neúplné instalace LIGERO.',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Abyste mohli používat LIGERO, musíte zadat následující řádek do Vašeho příkazového řádku (Terminal/Shell) jako root.',
        'Restart your webserver' => 'Restartujte Váš webserver',
        'After doing so your LIGERO is up and running.' => 'Po dokončení následujících operací je Váš LIGERO spuštěn a poběží',
        'Start page' => 'Úvodní stránka',
        'Your LIGERO Team' => 'Váš LIGERO tým',
        ...
        # Template: Test
        'LIGERO Test Page' => 'Testovací LIGERO stránka',
        'Unlock' => 'Odemknout',
        'Welcome %s %s' => '',
        'Counter' => 'Počítadlo',
        ...
        'LIGERO as provider' => 'LIGERO jako poskytovatel',
        'Operations' => '',
        'LIGERO as requester' => 'LIGERO jako žadatel',
        'Invokers' => '',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'Balíček není zkontrolován LIGERO Group! Není doporučeno jeho používání.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Install LIGERO' => 'Instalovat LIGERO',
        'Intro' => 'Úvod',
        ...
        'Enable cloud services to unleash all LIGERO features!' => 'Povolit cloudové služby pro využití všech možností LIGERO!',
        ...
        'LIGERO Daemon is not running.' => 'LIGERO plánovač není spuštěn.',
        ...
        'LIGERO Disk Partition' => 'LIGERO diskový oddíl',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Využití disku',
        'The partition where LIGERO is located is almost full.' => 'Particie kde je umístněno LIGERO je téměř plná.',
        'The partition where LIGERO is located has no disk space problems.' =>
            'Na particii, kde je nainstalováno LIGERO není problém s diskovým prostorem.',
        ...
        'The file system on your LIGERO partition is not writable.' => 'Na souborový systém na vaší LIGERO particii není možné zapisovat.',
...
' => '',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Novinky o LIGERO verzích!',
        'News about LIGERO.' => '',
        ...
        'Replaces the original sender with current customer\'s email address on compose answer in the ticket compose screen of the agent interface.' =>
            '',
        'Reports' => '',
        'Reports (LIGERO Business Solution™)' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Váš email s číslem Tiketu "<LIGERO_TICKET>" je svázán s "<LIGERO_MERGE_TO_TICKET>"',
