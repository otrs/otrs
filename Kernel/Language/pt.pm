...
sub Data {
    ...
    $Self->{Completeness}        = 0.327438186813187;
    ...
    $Self->{Translation} = {
        ...
        'It is highly recommended to send this data to LIGERO Group in order to get better support.' =>
            'É bastante recomendável enviar estes dados para o Grupo LIGERO para obter um melhor apoio.',
        ...
        'This will allow the system to send additional support data information to LIGERO Group.' =>
            'Isso permite que o sistema envie informações de dados de suporte adicionais para o Groupo LIGERO.',
        'Update' => 'Atualizar',
        ...
        'To enable data sending, please register your system with LIGERO Group or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Para permitir o envio de dados, por favor registe o seu sistema no Group LIGERO ou atualize a informação de registo do sistema (confirme que a opção \'Enviar dados de suporte\' está ativa)',
        ...
        'Go to LIGERO Package Manager' => 'Voltar à página de gestão de pacotes do LIGERO',
        ...
        'A new database user with limited permissions will be created for this LIGERO system.' =>
            'Vai ser criado um novo utilizador de base de dados com permissões limitadas para o LIGERO',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Para usar o LIGERO tem de executar o seguinte comando na consola, (Terminal/Shell) como root.',
        'Restart your webserver' => 'Reinicie o servidor Web',
        'After doing so your LIGERO is up and running.' => 'Depois de o fazer, o LIGERO estará funcional.',
        'Start page' => 'Página inicial',
        'Your LIGERO Team' => 'A equipa LIGERO',
        ...
        # Template: Test
        'LIGERO Test Page' => 'Página de Teste do LIGERO',
        'Unlock' => 'Desbloquear',
        'Welcome %s %s' => '',
        'Counter' => 'Contador',
        ...
        'LIGERO as provider' => 'LIGERO como prestador',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'O Pacote não foi verificado pelo Groupo LIGERO! Não é recomendado utilizar o Pacote.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Can\'t connect to LIGERO News server!' => 'Sem ligação ao servidor de Notícias!',
        'Can\'t get LIGERO News from server!' => 'Impossível obter Notícias do servidor!',
        ...
        'Enable cloud services to unleash all LIGERO features!' => 'Active os serviços cloud para desbloquear todas as funcionalidades LIGERO!',
        ...
        'LIGERO Daemon is not running.' => 'O Daemon LIGERO não está em execução.',
        ...
        '<p>The installation of packages which are not verified by the LIGERO Group is not possible by default.</p>' =>
            '<p>A instalação de pacotes que não são verificados pelo LIGERO Group não é possível por omissão.</p>',
...
' => '',
        ...
        'Adds a suffix with the actual year and month to the LIGERO log file. A logfile for every month will be created.' =>
            'Adiciona um sufixo com o ano e mês atual ao ficheiro de log do LIGERO. Vai ser criado um ficheiro mensal.',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'Notícias acerca dos lançamentos LIGERO!',
        'News about LIGERO.' => '',
...
Devemos voltar a estar online dentro de momentos.',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'O ticket com o número  "<LIGERO_TICKET>" foi fundido com o ticket "<LIGERO_MERGE_TO_TICKET>".',
