...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Edit Customer' => 'Editar a empresa do cliente',
        ...
        'Add Customer' => 'Adicionar utilizador de companhia',
        ...
        'Customer Management' => 'Gestão de utilizadores de cliente',
