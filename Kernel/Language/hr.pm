...
sub Data {
    ...
    $Self->{Completeness}        = 0.210508241758242;
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this LIGERO system.' =>
            'Novi korisnik baze sa ograničenim pravima bit će  kreiran za ovaj LIGERO sustav',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'After doing so your LIGERO is up and running.' => 'Nakon ovoga Vaš LIGERO je uključen i radi.',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO test stranica',
        'Unlock' => 'Otključano',
        'Welcome %s %s' => '',
        'Counter' => 'Brojač',
...
' => '',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Vaša poruka E-pošte sa brojem kartice "<LIGERO_TICKET>" je objedinjena sa karticom "<LIGERO_MERGE_TO_TICKET>"!',
