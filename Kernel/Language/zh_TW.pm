...
sub Data {
    ...
    $Self->{Completeness}        = 0.341174450549451;
    ...
    $Self->{Translation} = {
        ...
        'This LIGERO invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            '這個LIGERO調用程序後端模塊被調用後，負責準備需要發送給遠程系統的數據，並處理它的響應數據。',
        ...
        'The data from the invoker of LIGERO will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            '這個映射將對LIGERO調用程序輸出的數據進行處理，將它轉換為遠程系統所期待的數據。',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of LIGERO expects.' =>
            '這個映射將對響應數據進行處理，將它轉換為LIGERO調用程序所期待的數據。',
        'Asynchronous' => '異步的',
        'Condition' => '條件',
        'Edit this event' => '',
        ...
        'This LIGERO operation backend module will be called internally to process the request, generating data for the response.' =>
            '這個LIGERO操作後端模塊將被調用，以便處理請求、為響應生成數據。',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data LIGERO expects.' =>
            '這個映射將對請求數據進行處理，將它轉換為LIGERO所期待的數據。',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that LIGERO will process.' =>
            '在這裡您可以指定LIGERO能夠處理的SOAP消息的最大長度(以字節為單位)。',
        'Encoding' => '編碼',
        ...
        'This package is verified by LIGEROverify (tm)' => '此軟件包已通過LIGEROverify(tm)的驗証',
        'Uninstall' => '卸載',
        ...
        'If you use Regular Expressions, you also can use the matched value in () as [***] in the \'Set\' action.' =>
            '如果您使用了正則表達式，您可以取出()中匹配的值，再將它寫入LIGERO標記中(需採用[***]這種格式。)',
        ...
        'This system is registered with LIGERO Group.' => '本系統由LIGERO集團註冊。',
        'System type' => '系統類型',
        'Unique ID' => '唯一ID',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '我們會向您發布更多服務和產品。',
        'Can I use LIGERO without being registered?' => '如果不進行系統註冊，我還可以使用LIGERO嗎?',
        'System registration is optional.' => '系統註冊是可選的。',
        'You can download and use LIGERO without being registered.' => '不進行註冊，您仍然可以下載和使用LIGERO',
        ...
        'A registered system sends the following data to LIGERO Group:' => '註冊過的系統會將以下數據上傳給LIGERO集團：',
        'Fully Qualified Domain Name (FQDN), LIGERO version, Database, Operating System and Perl version.' =>
            '域名(FQDN)、LIGERO版本、數據庫、操作系統和Perl版本。',
        ...
        'How often does my LIGERO system send updates?' => '我的LIGERO系統上傳數據的頻度?',
        ...
        'You need to log in with your LIGERO-ID to deregister your system.' =>
            '',
        'LIGERO-ID' => '',
        'You don\'t have an LIGERO-ID yet?' => '還沒有LIGERO-ID嗎？',
        'Sign up now' => '現在註冊',
...
請注意，更換頭像需要一點時間才會生效。',
        ...
        'View notifications' => '',
        'Notifications' => '',
        'Notifications (LIGERO Business Solution™)' => '通知 (LIGERO Business Solution™)',
        'Personal preferences' => '個人設置',
        'Logout' => '退出',
        ...
        'Install Type' => '安裝類型',
        'Create a new database for LIGERO' => '為LIGERO創建新的數據庫',
        'Use an existing database for LIGERO' => '使用現有的數據庫',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            '為了能夠使用LIGERO, 您必須以root身份輸入以下行在命令行中(Terminal/Shell).',
        'Restart your webserver' => '請重啟您web服務器.',
        'After doing so your LIGERO is up and running.' => '完成後，您可以啟動LIGERO系統了.',
        'Start page' => '開始頁面',
        'Your LIGERO Team' => '您的LIGERO小組.',
        ...
        'LIGERO as provider' => 'LIGERO作為服務提供方',
        'Operations' => '',
        'LIGERO as requester' => 'LIGERO作為服務請求方',
        'Invokers' => '',
        ...
        'Enable cloud services to unleash all LIGERO features!' => '啟用雲端服務釋放所有LIGERO功能！',
        ...
        'LIGERO Daemon is not running.' => 'LIGERO Daemon未在運行',
...
' => '',
        ...
        'New Year\'s Eve' => '除夕',
        'New process ticket' => '',
        'News about LIGERO releases!' => '關於LIGERO發布的新聞！',
        'News about LIGERO.' => '關於 LIGERO 的最新資訊',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            '您的單號為"<LIGERO_TICKET>"的郵件工單 被合併到單號"<LIGERO_MERGE_TO_TICKET>" !',
