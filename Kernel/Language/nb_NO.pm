...
sub Data {
    ...
    $Self->{Completeness}        = 0.423076923076923;
    ...
    $Self->{Translation} = {
        ...
        'This will allow the system to send additional support data information to LIGERO Group.' =>
            'Dette vil tillate ditt system å sende tilleggsdatainformasjon til LIGERO gruppen.',
        'Update' => 'Oppdater',
        ...
        'System registration is a service of LIGERO Group, which provides a lot of advantages!' =>
            'Registrering av systemet er en tjeneste fra LIGERO gruppen, som kan tilby mange fordeler!',
        'Please note that the use of LIGERO cloud services requires the system to be registered.' =>
            'Vennligst husk på at bruken av LIGERO sine skytjenester krever at systemet er registrert.',
        'Register this system' => 'Registrer dette systemet',
        ...
        'e.g https://www.ligero.com:10745/api/v1.0 (without trailing backslash)' =>
            'f.eks. https://www.ligero.com:10745/api/v1.0 (uten skråstrek på slutten)',
        'Timeout' => '',
        ...
        'The full path of the certification authority directory where the CA certificates are stored in the file system.' =>
            '',
        'e.g. /opt/ligero/var/certificates/SOAP/CA' => '',
        ...
        'Go to LIGERO Package Manager' => 'Gå til LIGERO pakkehåndtereren',
        ...
        'To be able to use PGP in LIGERO, you have to enable it first.' => 'For å kunne bruke PGP funksjonen i LIGERO må du først aktivere den.',
        ...
        'This package is verified by LIGEROverify (tm)' => '',
        ...
        'This system is registered with LIGERO Group.' => 'Dette systemet er registrert med LIGERO gruppen.',
        ...
        'Please note that you can\'t register your system if LIGERO Daemon is not running correctly!' =>
            'Vennligst legg merket til at du ikke kan registrere systemet, dersom LIGERO tjenesten ikke kjører riktig!',
        'Instructions' => 'Instruksjoner',
        'System Deregistration not Possible' => '',
        'Please note that you can\'t deregister your system if you\'re using the %s or having a valid service contract.' =>
            '',
        'LIGERO-ID Login' => 'LIGERO-ID',
        'Read more' => 'Les mer',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use LIGERO without being registered?' => 'Kan jeg bruke LIGERO uten å være registrert?',
        'System registration is optional.' => 'Registrering er valgfritt.',
        'You can download and use LIGERO without being registered.' => 'Du kan laste ned og bruke LIGERO uten å være registrert.',
        ...
        'A registered system sends the following data to LIGERO Group:' => 'Et registrert system overfører følgende data til LIGERO gruppen:',
        'Fully Qualified Domain Name (FQDN), LIGERO version, Database, Operating System and Perl version.' =>
            'Fully Qualified Domain Name (FQDN), LIGERO versjon, Database-, Operativsystem- og Perl versjon.',
        ...
        'The description and system type you specify help you to identify and manage the details of your registered systems.' =>
            '',
        'How often does my LIGERO system send updates?' => 'Hvor ofte sender mitt LIGERO system oppdateringer?',
        ...
        'You need to log in with your LIGERO-ID to deregister your system.' =>
            '',
        'LIGERO-ID' => 'LIGERO-ID',
        'You don\'t have an LIGERO-ID yet?' => 'Har du ikke en LIGERO-ID enda?',
        ...
        'Here you can enter SQL to send it directly to the application database.' =>
            'Her kan du skrive SQL for å sende kommandoer rett til LIGERO sin database',
        'Options' => 'Valg',
        ...
        'A running LIGERO Daemon is mandatory for correct system operation.' =>
            'En kjørende LIGERO agent er påkrevd for at systemet skal kjøre riktig.',
        'Starting the LIGERO Daemon' => 'Innstillinger for LIGERO Agenten',
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating LIGERO at %s.' => '',
        ...
        'Create a new database for LIGERO' => '',
        'Use an existing database for LIGERO' => '',
        ...
        'A new database user with limited permissions will be created for this LIGERO system.' =>
            'En ny databasebruker med begrensede rettigheter vil bli opprettet for denne LIGERO-installasjonen.',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'For å kunne bruke LIGERO, må følgende linje utføres på kommandolinjen som root.',
        'Restart your webserver' => 'Restart webserveren din',
        'After doing so your LIGERO is up and running.' => 'Etter dette vil LIGERO være oppe og kjøre.',
        'Start page' => 'Startside',
        'Your LIGERO Team' => 'LIGERO-Teamet',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO Test-side',
        'Unlock' => 'Frigi sak',
        ...
        'LIGERO as provider' => 'LIGERO som en leverandør',
        'Operations' => 'Handlinger',
        'LIGERO as requester' => 'LIGERO som en etterspørrer',
        'Invokers' => '',
        ...
        'Package not verified by the LIGERO Group! It is recommended not to use this package.' =>
            'Pakken er ikke verifisert av LIGERO-gruppen! Det er anbefalt å ikke bruke denne pakken.',
        'Not Started' => '',
        'Updated' => '',
        'Already up-to-date' => '',
        'Installed' => '',
        ...
        'Enable cloud services to unleash all LIGERO features!' => 'Aktiver sky-tjenester for å kunne bruke alle LIGERO funksjoner',
        ...
        'LIGERO Daemon is not running.' => 'LIGERO tjenesten kjører ikke',
        ...
        'LIGERO Disk Partition' => 'LIGERO diskpartisjon',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Diskforbruk',
        'The partition where LIGERO is located is almost full.' => 'Partisjonen hvor LIGERO er plassert, er nesten full.',
        'The partition where LIGERO is located has no disk space problems.' =>
            'Partisjonen hvor LIGERO er plasser, har igjen diskplass problemer.',
        ...
        'The file system on your LIGERO partition is not writable.' => 'Filsystemet for din LIGERO partisjon er ikke mulig å skrive til.',
        ...
        'LIGERO requires apache to be run with the \'prefork\' MPM model.' =>
            'LIGERO krever Apache for å kunne kjøre \'prefork\' MPM modellen.',
        ...
        'Information about the LIGERO Daemon' => 'Informasjon om LIGERO Agenten',
...
' => '',
        ...
        'Define a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Sett et filter for HTML-visning som legger til lenker bak en gitt tekst. Bildeelementet tillater to typer inn-data. For det første navnet på et bilde (f.eks. bilde01.png). I det tilfellet vil LIGERO sin bilde-sti brukes. Den andre muligheten er å skrive inn URL til bildet',
        ...
        'Defines a filter for html output to add links behind CVE numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definerer et filter for HTML-visning for å legge til lenker bak CVE-nummer. Bilde-elementet tillater to typer inn-data. Enten navnet på en bilde-fil (f.eks. bilde01.png), der LIGERO vil gå utfra at bildet ligger i LIGERO sin bildemappe. Eller man kan oppgi URL til et bilde.',
        'Defines a filter for html output to add links behind MSBulletin numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definerer et filter i HTML-visningen for å legge til lenker bak MSBulletin-nummer. Bildeelementet tillater to typer inn-data. Enten navnet på en bilde-fil (f.eks. bilde01.png), der LIGERO vil gå utfra at bildet ligger i LIGERO sin bildemappe. Eller man kan oppgi URL til et bilde.',
        'Defines a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definerer et filter for HTML-visning som legger til lenker bak en definert tekst. Bilde-elementet tillater to typer inn-data. Enten navnet på en bilde-fil (f.eks. bilde01.png), der LIGERO vil gå utfra at bildet ligger i LIGERO sin bildemappe. Eller man kan oppgi URL til et bilde.',
        'Defines a filter for html output to add links behind bugtraq numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the LIGERO image path will be used. The second possiblity is to insert the link to the image.' =>
            'Definerer et filter for HTML-visning som legger til lenker bak BugTraq-numre. Bilde-elementet tillater to typer inn-data. Enten navnet på en bildefil (f.eks. bilde01.png), der LIGERO vil gå utfra at bildet ligger i LIGERO sin bildemappe. Eller man kan oppgi URL til et bilde.',
        ...
        'If enabled, LIGERO will deliver all JavaScript files in minified form.' =>
            'Hvis slått på vil LIGERO levere alle JavaScript-filer i minimert form',
        ...
        'Merged Ticket <LIGERO_TICKET> to <LIGERO_MERGE_TO_TICKET>.' => '',
        'Minute' => '',
        ...
        'News about LIGERO releases!' => 'Nyheter om LIGERO utgivelser!',
        'News about LIGERO.' => '',
        ...
        'Resets and unlocks the owner of a ticket if it was moved to another queue.' =>
            '',
        'Resource Overview (LIGERO Business Solution™)' => 'Ressursoversikt (LIGERO Business Solution™)',
        'Responsible Tickets' => '',
        'Responsible Tickets.' => '',
        ...
        'Shows information on how to start LIGERO Daemon' => 'Vis informasjon om hvordan starte LIGERO Agenten',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Din e-postsak med nummer "<LIGERO_TICKET>" er flettet med "<LIGERO_MERGE_TO_TICKET>". ',
