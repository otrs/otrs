...
sub Data {
    ...
    $Self->{Completeness}        = 0.178056318681319;
    ...
    $Self->{Translation} = {
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating LIGERO at %s.' => 'Tõlkele saate kaasa aidata %s veebilehel.',
        ...
        'Install Type' => '',
        'Create a new database for LIGERO' => 'Loo LIGEROile uus andmebaas',
        'Use an existing database for LIGERO' => 'Kasuta olemasolevat andmebaasi',
        ...
        'To be able to use LIGERO you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'LIGERO kasutamiseks peate järgneva käsu sisestama süsteemi root-kasutajana.',
        'Restart your webserver' => 'Taaskäivita veebiserver.',
        'After doing so your LIGERO is up and running.' => 'Peale seda LIGERO töötab.',
        'Start page' => 'Algusleht',
        'Your LIGERO Team' => 'LIGERO meeskond',
        ...
        # Template: Test
        'LIGERO Test Page' => 'LIGERO testileht',
        'Unlock' => 'Eemalda lukk',
        'Welcome %s %s' => '',
        'Counter' => 'Loendur',
        ...
        'Install LIGERO' => 'Paigalda LIGERO',
        'Intro' => 'Sissejuhatus',
...
' => '',
        ...
        'New process ticket' => '',
        'News about LIGERO releases!' => 'LIGEROi versiooniuudised',
        'News about LIGERO.' => '',
        ...
        'Replaces the original sender with current customer\'s email address on compose answer in the ticket compose screen of the agent interface.' =>
            '',
        'Reports' => 'Raportid',
        'Reports (LIGERO Business Solution™)' => 'Raportid (LIGERO Business Solution™)',
        ...
        'Your email with ticket number "<LIGERO_TICKET>" is merged to "<LIGERO_MERGE_TO_TICKET>".' =>
            'Teie kiri intsidendinumbriga "<LIGERO_TICKET>" ühendati intsidendiga "<LIGERO_MERGE_TO_TICKET>".',
