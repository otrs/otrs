...
package Kernel::Output::HTML::Dashboard::MyTicketsGeneric;
...
#    }
    ...
    # show my open Ticket
    if ( $TicketSearchSummary{MyOpenTickets} ) {
        $LayoutObject->Block(
            Name => 'ContentLargeTicketGenericFilterMyOpenTicket',
            Data => {
                %Param,
                %{ $Self->{Config} },
                Name => $Self->{Name},
    ...
    # show close Ticket
    if ( $TicketSearchSummary{CloseTickets} ) {
        $LayoutObject->Block(
            Name => 'ContentLargeTicketGenericFilterCloseTicket',
            Data => {
                %Param,
                %{ $Self->{Config} },
                Name => $Self->{Name},
