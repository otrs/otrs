...
package Kernel::Output::HTML::Dashboard::MyQueueTicketsGeneric;
...
sub Run {
    ...
    if ( $TicketSearchSummary{MyQueueUnassignedTicket} ) {
        $LayoutObject->Block(
            Name => 'ContentLargeTicketGenericFilterMyQueueUnassignedTicket',
            Data => {
                %Param,
                %{ $Self->{Config} },
                Name => $Self->{Name},
    ...
    # show my queue open Ticket
    if ( $TicketSearchSummary{MyQeueOpenTickets} ) {
        $LayoutObject->Block(
            Name => 'ContentLargeTicketGenericFilterMyQueueOpenTicket',
            Data => {
                %Param,
                %{ $Self->{Config} },
                Name => $Self->{Name},
    ...
    # show my queue close Ticket
    if ( $TicketSearchSummary{MyQueueCloseTickets} ) {
        $LayoutObject->Block(
            Name => 'ContentLargeTicketGenericFilterMyQueueCloseTickets',
            Data => {
                %Param,
                %{ $Self->{Config} },
                Name => $Self->{Name},
