...
sub new {
    ...
    if ( !-w $Self->{DataDir} ) {
        ...
        $Kernel::OM->Get('Kernel::System::Log')->Log(
            Priority => 'notice',
            Message  => "Can't write $Self->{DataDir}! try: \$LIGERO_HOME/bin/ligero.SetPermissions.pl!",
        );
        die "Can't write $Self->{DataDir}! try: \$LIGERO_HOME/bin/ligero.SetPermissions.pl!";
    }
