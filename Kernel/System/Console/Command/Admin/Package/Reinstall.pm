...
sub Configure {
    ...
    $Self->Description('Reinstall an LIGERO package.');
    $Self->AddOption(
        Name        => 'force',
    ...
    $Self->AddArgument(
        Name => 'location',
        Description =>
            "Specify a file path, a remote repository (http://ftp.ligero.org/pub/ligero/packages/:Package-1.0.0.opm) or just any online repository (online:Package).",
        Required   => 1,
        ValueRegex => qr/.*/smx,
    );
