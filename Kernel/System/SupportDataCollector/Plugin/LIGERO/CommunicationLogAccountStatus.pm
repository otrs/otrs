...
package Kernel::System::SupportDataCollector::Plugin::LIGERO::CommunicationLogAccountStatus;
...
sub GetDisplayPath {
    return Translatable('LIGERO') . '/' . Translatable('Communication Log Account Status (last 24 hours)');
}
